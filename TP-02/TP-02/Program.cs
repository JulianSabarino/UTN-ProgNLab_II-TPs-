...
namespace TP_02_2018
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // Muestro solo Moto
            Console.WriteLine(taller.Listar(taller, Taller.ETipo.Ciclomotor)); //Taller -> taller
            Console.WriteLine("<-----------PRESIONE UNA TECLA PARA CONTINUAR----------->");
            Console.ReadKey();
            Console.Clear();

            // Muestro solo Automovil
            Console.WriteLine(taller.Listar(taller, Taller.ETipo.Sedan)); //Taller -> taller
            Console.WriteLine("<-----------PRESIONE UNA TECLA PARA CONTINUAR----------->");
            Console.ReadKey();
            Console.Clear();

            // Muestro solo Camioneta
            Console.WriteLine(taller.Listar(taller, Taller.ETipo.SUV)); //Taller -> taller
